  ...
  return (
    <div className="border-b-[.5px] border-white/20 z-50">
      <div className="container  mx-auto px-4 md:px-10 w-full ">
        {" "}
        <div className=" flex flex-col md:flex-row justify-start  md:justify-center items-start md:items-center font-light text-white gap-2 md:gap-6 md:text-base py-2 md:py-4 text-sm">
          <a
